...
('default-activity-todo', 'To Do', 'activity', '#6B7280', TRUE, 1, 'default-org'),
('default-activity-progress', 'In Progress', 'activity', '#3B82F6', TRUE, 2, 'default-org'),
('default-activity-review', 'In Review', 'activity', '#F59E0B', TRUE, 3, 'default-org'),
('default-activity-done', 'Done', 'activity', '#10B981', TRUE, 4, 'default-org'),
('default-task-todo', 'To Do', 'task', '#6B7280', TRUE, 1, 'default-org'),
('default-task-progress', 'Working on it', 'task', '#3B82F6', TRUE, 2, 'default-org'),
('default-task-stuck', 'Stuck', 'task', '#EF4444', TRUE, 3, 'default-org'),
('default-task-done', 'Done', 'task', '#10B981', TRUE, 4, 'default-org');

-- Verification queries
SELECT 'PMActivity2 database schema created successfully!' AS message;
SHOW TABLES;
SELECT COUNT(*) AS table_count FROM information_schema.tables WHERE table_schema = 'PMActivity2';
